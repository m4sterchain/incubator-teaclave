...
Originally built as a general-purpose secure computing framework, Teaclave has evolved into a vibrant ecosystem focused on **SDKs** that enable developers to directly build custom Trusted Applications. This shift reflects organic community usage and our refined mission.
...
- 📦 [Teaclave Crates](https://github.com/apache/incubator-teaclave-crates) — Ported and TEE-tailored Rust dependencies
